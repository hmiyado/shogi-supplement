...
val PLACEMENT_STRATEGY_DEFS: List<PlacementDef> = listOf(
    ...
    PlacementDef(
        ...
        plyCap = 30,
        source = "shougi.jp/senpou/furibisya/tsunogin_nakabisya.html（本文『2つの銀がツノのように見えることからこの名前がついた』。掲載図で左銀6七・右銀4七を確認。飛車は中飛車(5筋)へ向かう途中の一時的な配置(図では5九のまま)であり定着筋は既存のRookSettleTrackerが別途『振り飛車:中飛車』として判定するため、本タグでは銀のツノ形のみを必須とした）",
        samples = listOf(
