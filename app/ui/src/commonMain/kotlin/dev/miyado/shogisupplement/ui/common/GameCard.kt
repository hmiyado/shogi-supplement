...
fun GameCard(
    ...
    val timeControlLine = buildTimeControlLine(game.sourcePlace, game.timeControlRaw, game.timeControlByoyomiRaw)
        ...
        Row(
            ...
            if (selectable) {
                Checkbox(
                    ...
                    modifier = Modifier.testTag("game_card_checkbox_${game.id}"),
                )
            }
